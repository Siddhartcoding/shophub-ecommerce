...
import logo from "../assits/logo-4.png";
import Image from "../assits/Image";
import logolight from "../assits/logolight.png";
            ...
            {sidenav && (
              <div className="fixed top-0 left-0 w-full h-screen bg-black text-gray-200 bg-opacity-80 z-50">
                <motion.div
                  ...
                  transition={{ duration: 0.5 }}
                  className="w-[65%] h-full relative"
                >
                  <div className="w-full h-full bg-primeColor p-6">
                    ...
                    <div className="mt-4">
                      <h1
                        ...
                        className="flex justify-between text-lg cursor-pointer items-center font-titleFont mb-2"
                      >
                        Shop by Category{" "}
