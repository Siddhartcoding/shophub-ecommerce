      ...
      <div className="w-full lgl:w-1/2 h-full">
        {successMsg ? (
          ...
          <form className="w-full lgl:w-[450px] h-screen flex items-center justify-center">
            <div className="px-6 py-4 w-full h-[90%] flex flex-col justify-center  scrollbar-thumb-primeColor">
              <h1 className="font-titleFont font-semibold text-3xl md:text-4xl mb-4 relative group">
                Create an account
                <span className="absolute bottom-0 left-0 w-[21.5rem] h-0.5 bg-black/55 transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></span>
              </h1>
