...
const Cart = () => {
 const {isLoggedIn} = useAuthValue();
    const { cart, addToCart, total,
        setTotal,
        removeFromCart,
        clearCart,
        purchaseAll,
        myorders,
        itemInCart, setShow, handlePurchase } = useProductContext();
                    ...
                    <div className="max-w-7xl gap-4 flex justify-end mt-4">
                        <div className="w-96 flex flex-col gap-4">
                            ...
                            <div className="flex justify-end">
                                <Link to="/">
                                    <button onClick={purchaseAll} className="w-52 h-10 bg-primeColor text-white hover:bg-black duration-300">
                                        Proceed to Checkout
                                    </button>
                                </Link>
                            </div>
